...
if [ ! -z $1 ] && [ "$1" != "skip" ] ; then
	...
	cd rootfs
	curl -L https://dl.google.com/chromeos/rammus/15823.60.0/stable-channel/chromeos_15823.60.0_rammus_stable-channel_full_mp-v4.bin-gy3dintggezgdns3ll7apoz6347cma4i.signed -o ./update.signed || { echo "Failed to Download the OTA update"; exit 1; }
