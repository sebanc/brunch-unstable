...
rm ../rootc/lib/firmware/amd-ucode.tar ; rm ../rootc/lib/firmware/amd-ucode.tar.zst ; rm ../rootc/lib/firmware/intel-ucode.tar ; rm ../rootc/lib/firmware/intel-ucode.tar.zst || { echo "Failed to cleanup intel / amd ucode zst files"; exit 1; }
